    ...
    schema: {
      ...
      properties: {
        ...
        description: {
          ...
          label: "Section Description",
          placeholder:
            "Streamline your entire NetSuite implementation lifecycle",
          formField: "textarea",
        },
              ...
              items: {
                ...
                properties: {
                  ...
                  desc: {
                    ...
                    label: "Step Description",
                    placeholder:
                      "Analyze current retail processes and requirements",
                    required: true,
                    formField: "textarea",
                  },
                  icon: {
        ...
        steps: [
          {
            ...
            desc:
              "Analyze current retail processes, identify gaps, and document requirements for your NetSuite implementation",
            icon:
              "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
            benefits: [
          ...
          },
          {
            title: "Solution Design",
            desc:
              "Design NetSuite configuration optimized for your retail workflows and business processes",
            icon:
          ...
          },
          {
            ...
            desc:
              "Deploy and configure NetSuite with your retail-specific customizations and integrations",
            icon:
          ...
          },
          {
            title: "Go-Live & Support",
            desc:
              "Launch your NetSuite retail solution with comprehensive support and optimization",
            icon:
