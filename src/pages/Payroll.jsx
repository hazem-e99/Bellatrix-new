...
export default function PayrollPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen w-full ">
      ...
      {/* Contact/CTA Section */}
      <section id="contact" className="py-20 bg-[var(--color-brand-dark-navy)]">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white">
            {payrollData?.cta?.title ? (
              ...
              <>
                ...
                <span className="text-[var(--color-primary)]">Payroll?</span>
              </>
            )}
          </h2>
          ...
          <button
            ...
            className="inline-flex items-center px-8 py-4 rounded-lg bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white font-medium text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
