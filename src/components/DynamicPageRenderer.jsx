      ...
      try {
        ...
        if (Array.isArray(sectionsToRender) && sectionsToRender.length > 0) {
          ...
          if (sectionsToRender.length === 0) {
            ...
            console.warn(" [WARNING] No visible components to load! All components may be hidden.");
  ...
  const getFilteredComponents = () => {
    ...
    if (Array.isArray(sectionsToRender) && sectionsToRender.length > 0) {
      ...
      if (sectionsToRender.length === 0) {
        ...
        console.warn(" [WARNING] No visible components found! All components may be hidden.");
