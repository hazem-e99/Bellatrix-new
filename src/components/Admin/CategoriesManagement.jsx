...
const API_BASE = `${import.meta.env.VITE_API_BASE_URL_WITH_API || "https://68.178.169.236:5000/api"}/Categories`;
const NAVBAR_API = `${
  import.meta.env.VITE_API_BASE_URL_WITH_API || "https://68.178.169.236:5000/api"
}/Categories/navbar`;
