...
const HeroSection = (props) => {
  ...
  const rawData = {
    backgroundVideo: propBackgroundVideo || propsData?.backgroundVideo || defaultData?.backgroundVideo || "/Videos/HomeHeroSectionV.mp4",
    titleParts: propTitleParts || propsData?.titleParts || defaultData?.titleParts || ["Where", "Vision", "Meets", "Reality"],
    description: propDescription || propsData?.description || defaultData?.description || "We don't just implement solutions—we craft digital experiences that transform the way you do business",
    ctaButton: propCtaButton || propsData?.ctaButton || defaultData?.ctaButton || {
      text: "Start Implementation",
      icon: "M13 7l5 5m0 0l-5 5m5-5H6",
      variant: "primary",
    },
  ...
  console.log(" [ImplementationHeroSection] Component received data:", {
    directProps: { propBackgroundVideo, propTitleParts, propDescription, propCtaButton },
    propsData,
    defaultData,
    finalData: rawData,
