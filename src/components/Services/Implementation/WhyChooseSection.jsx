...
const WhyChooseSection = (props) => {
  ...
  const displayData = {
    title: propTitle || propsData?.title || defaultData?.title || "Why Choose Bellatrix for Implementation?",
    subtitle: propSubtitle || propsData?.subtitle || defaultData?.subtitle || "We bring years of expertise, proven methodologies, and cutting-edge solutions to ensure your implementation success",
    image: propImage || propsData?.image || defaultData?.image || "/Videos/implementation/whyChoese.jpg",
    features: propFeatures || propsData?.features || defaultData?.features || [],
  };
