  ...
  return (
    ...
    <main className="min-h-screen text-[var(--color-text-primary)]">
      ...
      <section
        ...
        className="w-full min-h-screen bg-[var(--color-brand-dark-navy)] py-24 md:py-32 text-center flex flex-col items-center justify-center relative overflow-hidden"
      ...
      <section
        ...
        className="py-16 bg-[var(--color-brand-dark-navy)] text-[var(--color-text-inverse)] text-center"
