  ...
  return (
    <main className="bg-gradient-to-br from-blue-50 to-white min-h-screen text-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {data.benefits.items.map((benefit, index) => (
              <div key={index} className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-1"></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-10 text-blue-800 text-center">
            {data.popularIntegrations.title}
          </h2>
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <p className="text-lg md:text-xl mb-8">
            {typeof data.cta.subtitle === "string"
              ? data.cta.subtitle
              : data.cta.subtitle?.subtitle ||
                data.cta.subtitle?.title ||
                "CTA Subtitle"}
          </p>
