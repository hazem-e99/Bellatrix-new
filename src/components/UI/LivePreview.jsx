      ...
      switch (componentType) {
        ...
        case "RetailHeroSection": {
          ...
          const transformedRetailHeroData = {
            ...
            subtitle: componentData.subtitle || "Transform your retail operations",

            description: componentData.description || "Comprehensive NetSuite solutions for retail businesses",
        ...
        case "RetailSolutionsSection": {
          ...
          const transformedData = {
            ...
            netSuiteSolutions: componentData.netSuiteSolutions || componentData.solutions ||
        ...
        case "RetailChallengesSection": {
          ...
          const transformedData = {
            ...
            retailChallenges: componentData.retailChallenges || componentData.challenges || componentData.items || [],
        ...
        case "RetailFeaturesSection": {
          ...
          const transformedData = {
            ...
            subtitle: componentData.subtitle || "Key features of our retail solution",

            retailFeatures: componentData.retailFeatures || componentData.features ||
        ...
        case "RetailIndustryStats": {
          ...
          const transformedData = {
            ...
            description: componentData.description || "Key metrics that demonstrate our retail excellence",
        ...
        case "RetailImplementationSection": {
          ...
          const transformedData = {
            ...
            description: componentData.description || "Our implementation process ensures success",
