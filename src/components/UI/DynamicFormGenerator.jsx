...
const DynamicFormGenerator = ({
  ...
  const handleMediaSelect = (url) => {
    ...
    if (mediaPickerCallback) {
      ...
      console.log(" [MEDIA SELECT] Using handleChange for field:", mediaPickerField);
        ...
        return (
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const mediaType = fieldSchema.formField === "media-video" || fieldSchema.mediaType === "video" 

                    ? "video" 

                    : fieldSchema.formField === "media-image" || fieldSchema.mediaType === "image"
            ...
            <small className="text-xs text-gray-400 flex items-center gap-1">
              ...
              {fieldSchema.mediaType === "video" || fieldSchema.formField === "media-video" ? (
            ...
            {value && (
              ...
              <div className="mt-2 relative group inline-block">
                ...
                {(fieldSchema.mediaType === "video" || fieldSchema.formField === "media-video") ? (
                  ...
                  <video src={value} className="h-16 object-cover rounded border border-white/20" muted />

                ) : (

                  <img src={value} alt="Preview" className="h-16 object-cover rounded border border-white/20" 
          ...
          <div key={fullPath} className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                onClick={() => openMediaPicker(fullPath, fieldSchema.mediaType || "all")}
            ...
            <p className="text-xs text-gray-400 flex items-center gap-1">
              ...
              {fieldSchema.mediaType === "video" ? (
                ...
                <><VideoCameraIcon className="h-3 w-3" /> Enter URL or click Browse to upload/select video</>

              ) : fieldSchema.mediaType === "image" ? (

                <><PhotoIcon className="h-3 w-3" /> Enter URL or click Browse to upload/select image</>

              ) : (

                <><CloudArrowUpIcon className="h-3 w-3" /> Enter URL or click Browse to upload/select media</>
  ...
  return (
    ...
    <>
      ...
      <MediaPicker
        ...
        title={mediaPickerType === "video" ? "Choose Video" : mediaPickerType === "image" ? "Choose Image" : "Choose Media"}
